...
extern template class GEDEnv<GXLNodeID, ged::AttrLabel, ged::AttrLabel>;
// todo: I think install.py may be errored now since I added the AttrLabel line above.
// Check `append_ged_env_hpp` in install.py.
#endif /* SRC_ENV_GED_ENV_GXL_CPP_ */
#endif /* GXL_GEDLIB_SHARED */

// Test code to check if the file is included correctly:
